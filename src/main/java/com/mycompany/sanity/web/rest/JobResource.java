...
import com.mycompany.sanity.domain.Job;
import com.mycompany.sanity.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.mycompany.sanity.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
